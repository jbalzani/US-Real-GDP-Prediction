...
model_compar_table <- as_tibble(
  ...
  'General To Specific ADL Model' = c(round(reg_lag_2_12summ$r.squared, 3), round(AIC_adl_model, 3), round(BIC_adl_model, 3)),
  'Optimal Model AIC' = c(round(reg_lag_234_123summ$r.squared, 3), round(AIC(reg_lag_234_123), 3), round(BIC(reg_lag_234_123), 3)),
...
combined_data_eval <- combined_data_eval %>%
  mutate(ar_growth_rate_predictions = wf_predictions2)
