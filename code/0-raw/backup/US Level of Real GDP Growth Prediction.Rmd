...
\newline
gamma3*real_gdp_growth_lag3 + gamma4*real_gdp_growth_lag4 + 
\newline
epsilon, where epsilon is the error term
\newpage
**Implementation:**
...
library(rollRegres)
test_predictions <- roll_regres(reg_lag_2_12, width = 1, do_downdates = FALSE)
```
