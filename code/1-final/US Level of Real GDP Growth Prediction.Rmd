...
A191RL1Q225SBEA <- read_csv("C:/Users/John/OneDrive/Documents/Economics Study/Econometrics/backup GDP Prediction from 10Y3M IR Difference/A191RL1Q225SBEA.csv")
```
...
Note: T10Y3M data is confined to the data on first day of the month in which data is available. Only quarterly data matching the data on real GDP growth is used.

Note: April 2008 was chosen to separate the estimation and evaluation samples because this was the latest data point before the serious recession of 2008.
