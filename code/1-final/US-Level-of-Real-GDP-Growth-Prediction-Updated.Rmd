...
combined_data_eval %>% ggplot(aes(x = DATE)) +
  ...
  # ggsave("change_this_name_later.png") #this makes the file appear in Plot window, from      #there use Zoom button to get a high quality image, then right click, Copy Image, and save   #from MS Paint (best way so far)
```
...
combined_data_eval %>%
  ...
  #ggsave("test.png") #may show below and give open image option, screenshot from there
```
